  ...
  return (
    <>
      <ParallaxStyled id="parallax_1">
        ...
        <div
          className="parallax_1 layer layer_1"
          data-depth="0.1"
        >
          border front
        </div>
        <div
          className="parallax_1 layer layer_2"
          data-depth="0.2"
        >
          div arllasd
        </div>
        <div
          className="parallax_1 layer layer_3"
          data-depth="0.5"
        >
          div arllasd
        </div>
        <div
          className="parallax_1 layer layer_5"
          data-depth="0.85"
        >
          div arllasd
        </div>
        <div
          className="parallax_1 layer layer_4 borderFront"
          data-depth="0.8"
        >
          border back
        </div>

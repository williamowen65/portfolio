        ...
        <HeroStyled className="hero">
          ...
          <Icons />
                ...
                <div className="subInfo">
                    <p>
                        Available for{" "}
                        <EmbeddedLink type="link" href="/about">
                            hire & contracts
                        </EmbeddedLink>
                    </p>
...
const HeroStyled = styled.div`
    ...
    .imageContainer {
        ...
        /* background: linear-gradient(-103deg, ${configValues.theme.dark.color
            .white} 3%, transparent 37%); */
    ...
    transform: translateX(-50%); */
        ...
        height: 80%;
        filter: blur(0px);
        box-shadow: 1px 1px 2px #c193c1, -1px 1px 2px #ad37ad,
            0px -1px 2px #5fcf19;
        ...
        h2 {
            ...
            text-shadow: 1px 1px 1px ${configValues.theme.dark.logoTint},
